function generateAndSubmitDsqShell(jobFilePath)
    ...
    system(sprintf('bash -c "module load dSQ; module load miniconda; dsq --job-file %s --batch-file %s -o %s --status-dir %s --partition day --cpus-per-task 25 --mem-per-cpu 512 --time 1:00:00 --mail-type ALL"', ...
