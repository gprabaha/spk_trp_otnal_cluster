function generateAndSubmitDsqShell(jobFilePath)
    ...
    system(sprintf('bash -c "module load dSQ; module load miniconda; dsq --job-file %s --batch-file %s -o %s --status-dir %s --partition psych_week --cpus-per-task 48 --mem-per-cpu 2048 --time 7-00:00:00 --mail-type ALL"', ...
